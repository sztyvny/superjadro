...
\lstinputlisting[language = {[x86masm]Assembler}]{jadro2.asm}

\subsection{\textit{STRUKT.TXT}}
\lstinputlisting[language = {[x86masm]Assembler}]{STRUKT.TXT}

\subsection{\textit{PM\_DATA.TXT}}
%\lstinputlisting[language = {[x86masm]Assembler}]{PM_DATA.TXT}

\subsection{\textit{PM\_EXC.TXT}}
%\lstinputlisting[language = {[x86masm]Assembler}]{PM_EXC.TXT}

\subsection{\textit{PM\_IDT.TXT}}
%\lstinputlisting[language = {[x86masm]Assembler}]{PM_IDT.TXT}
